...
import com.xrosstools.xstate.idea.editor.model.EndNode;
import com.xrosstools.xstate.idea.editor.model.Event;
import com.xrosstools.xstate.idea.editor.model.RouteStyle;
import com.xrosstools.xstate.idea.editor.model.StartNode;
...
public class StateMachineDiagramReader implements StateMachineDiagramConstants {
	...
	private void linkState(StateMachine machine, Node transitionsNode) {
		...
		for(int i = 0; i < transitions.size(); i++) {
			...
			transition.setTransitGuard(getAttribute(node, TRANSIT_GUARD));
		}
	}
